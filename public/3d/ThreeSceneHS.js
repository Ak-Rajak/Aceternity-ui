...
const ThreeSceneHS = () => {
    ...
    useEffect(() => {
        ...
        const material = new THREE.TextureLoader().load('saturn.jpeg');
        ...
        const spaceTexture = new THREE.TextureLoader().load('sp.svg');
        ...
        const moonTexture = new THREE.TextureLoader().load('p2.jpeg');
        const norm = new THREE.TextureLoader().load('p1.jpeg');
        ...
        moonMesh.position.set(3, 0, 2); // Move it so it's visible
        scene.add(moonMesh);
// Animation loop
